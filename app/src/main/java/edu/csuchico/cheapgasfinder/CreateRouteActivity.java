...
public class CreateRouteActivity extends Activity implements ActionBar.TabListener,
        GasMapFragment.OnFragmentInteractionListener,
        ...
        GooglePlayServicesClient.OnConnectionFailedListener
{
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return GasMapFragment.newInstance(car);
                case 1:
